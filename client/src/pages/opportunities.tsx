    ...
    <Card className="h-full">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-sm text-gray-600">Avg Sell Price</div>
      ...
      <div className="p-6">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">AI is analyzing your sales history data to identify profitable opportunities...</p>
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">AI-powered buying recommendations based on your sales history</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-sm text-gray-600">Top Makes</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
