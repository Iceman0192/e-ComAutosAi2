              ...
              <table className="w-full min-w-[600px]">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-2 px-2 font-medium text-gray-700 dark:text-gray-300 text-sm">Damage Type</th>
                    <th className="text-right py-2 px-2 font-medium text-gray-700 dark:text-gray-300 text-sm">Count</th>
                    <th className="text-right py-2 px-2 font-medium text-gray-700 dark:text-gray-300 text-sm">Average</th>
                    <th className="text-right py-2 px-2 font-medium text-gray-700 dark:text-gray-300 text-sm hidden sm:table-cell">Range</th>
                    <th className="text-right py-2 px-2 font-medium text-gray-700 dark:text-gray-300 text-sm">Median</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <td className="py-3 px-2">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <div 
                            ...
                            style={{ backgroundColor: data.color }}
                          />
                          <span className="font-medium text-sm sm:text-base truncate">{data.damage}</span>
                        </div>
                      </td>
                      <td className="text-right py-3 px-2 text-gray-600 dark:text-gray-400 text-sm">
                        {data.count}
                      </td>
                      <td className="text-right py-3 px-2 font-semibold text-sm">
